...
BEGIN
  ...
  q := jsonb_build_array(
    ...
    jsonb_build_object('number',9,
      'question',E'다음 중 밑줄 친 부분과 바꿔 쓸 수 있는 것은?\n\nShe is the teacher <u>that</u> inspired many students.',
    ...
    jsonb_build_object('number',27,
      ...
      'options',jsonb_build_array(
        'She is the doctor <u>who</u> saved my life.',
        '<u>Who</u> is the man standing over there?',
        'She isn''t sure <u>who</u> she should ask.',
        '<u>Who</u> will win the game tonight?',
        '<u>Who</u> do you admire most?'),
      'answer','1'),

    jsonb_build_object('number',28,
      'question',E'다음 중 밑줄 친 which의 쓰임이 나머지와 다른 것은?',
      'options',jsonb_build_array(
        '<u>Which</u> flavor of ice cream do you prefer?',
        'Tell me <u>which</u> color you like best.',
        'I don''t know <u>which</u> road leads to the park.',
        'She asked me <u>which</u> seat to take.',
        'Look at the cat <u>which</u> is climbing the tree.'),
      'answer','5'),

    jsonb_build_object('number',29,
      'question',E'다음 중 밑줄 친 who의 쓰임이 나머지와 다른 것은?',
      'options',jsonb_build_array(
        'I can''t tell <u>who</u> made this mess.',
        'Do you know <u>who</u> that man is?',
        '<u>Who</u> is the tallest student in the class?',
        'The woman <u>who</u> lives next door is a dentist.',
        '<u>Who</u> do you think did this?'),
      'answer','4'),

    jsonb_build_object('number',30,
      'question',E'다음 중 밑줄 친 who의 쓰임이 나머지와 다른 것은?',
      'options',jsonb_build_array(
        'Guess <u>who</u> this is.',
        '<u>Who</u> is that boy?',
        'Do you know <u>who</u> the owner is?',
        'I don''t remember <u>who</u> that man is.',
        'He is the student <u>who</u> broke the rules.'),
      'answer','5'),

    jsonb_build_object('number',31,
      'question',E'다음 중 밑줄 친 부분의 쓰임이 다른 하나는?',
      'options',jsonb_build_array(
        'Do you know <u>who</u> my English teacher is?',
        'There was an old castle <u>that</u> became a museum.',
        'She gave me a ring <u>which</u> was made of silver.',
        'I know a pilot <u>who</u> flew around the world.',
        'Students <u>who</u> study hard usually get good grades.'),
      'answer','1'),

    jsonb_build_object('number',32,
      'question',E'다음 중 밑줄 친 부분의 쓰임이 <보기>와 같은 것은?\n\n<보기>\nI can create a robot <u>that</u> helps elderly people.',
      'options',jsonb_build_array(
        'Where did you find <u>that</u>?',
        'I believe <u>that</u> she is honest.',
        'Are you sure <u>that</u> it will rain?',
        'The dog <u>that</u> is barking loudly is mine.',
        'Do you think <u>that</u> he will come?'),
      'answer','4'),

    jsonb_build_object('number',33,
      'question',E'다음 중 밑줄 친 부분의 쓰임이 다른 하나는?',
      'options',jsonb_build_array(
        'Look at the bird <u>that</u> is sitting on the roof.',
        'There is a small shop <u>that</u> sells old books.',
        'He thinks <u>that</u> the movie is boring.',
        'I bought a shirt <u>that</u> has long sleeves.',
        'She always eats food <u>that</u> is healthy.'),
      'answer','3'),

    jsonb_build_object('number',34,
      'question',E'다음 중 밑줄 친 부분의 쓰임이 <보기>와 같은 것은? (정답 2개)\n\n<보기> A girl <u>that</u> called this morning left a message.',
      'options',jsonb_build_array(
        '<u>That</u> bag is mine.',
        'This is cheaper than <u>that</u>.',
        'Is he the boy <u>that</u> won the prize?',
        'I hope <u>that</u> you feel better.',
        'A man and his cat <u>that</u> were sitting on the bench looked peaceful.'),
      'answer','3, 5'),
    ...
    jsonb_build_object('number',48,
      ...
      'options',jsonb_build_array(
        'Have you seen a movie <u>who</u> was directed by Spielberg?',
        'I met a boy <u>who</u> was waiting at the bus stop.',
        'I have a nephew <u>that</u> is very smart.',
        'He has a son <u>that</u> is good at soccer.',
        'Look at the kite <u>which</u> is flying in the sky.'),
      'answer','1'),

    jsonb_build_object('number',49,
      'question',E'다음 중 밑줄 친 부분의 쓰임이 올바른 것은?',
      'options',jsonb_build_array(
        'Look at the tower <u>that stand</u> on the square.',
        'A dolphin is an animal <u>that live</u> in the ocean.',
        'The man who is reading a newspaper <u>are</u> my uncle.',
        'Ms. Lee has a daughter <u>who like</u> to draw pictures.',
        'The bridge <u>which connects</u> the two cities is famous.'),
      'answer','5'),

    jsonb_build_object('number',50,
      'question',E'다음 중 밑줄 친 부분이 어법상 어색한 것은?',
      'options',jsonb_build_array(
        'An airplane is a machine <u>which flies</u>.',
        'I don''t like people <u>who never stops talking</u>.',
        'Grace lives in the house <u>which is 100 years old</u>.',
        'My father will buy a new car <u>which costs $5000</u>.',
        'Do you know anybody <u>who can play the drums</u>?'),
      'answer','2'),

    jsonb_build_object('number',51,
      'question',E'다음 중 밑줄 친 부분이 어법상 어색한 것은?',
      'options',jsonb_build_array(
        'A firefighter is a person <u>who</u> fights fires.',
        'She has to finish a project <u>which</u> has 12 sections.',
        'A whale is a mammal <u>which</u> is the biggest in the ocean.',
        'I want to meet the woman <u>that</u> wears a yellow dress.',
        'He didn''t read the email from me <u>who</u> was on the desk.'),
      'answer','5'),

    jsonb_build_object('number',52,
      'question',E'다음 중 밑줄 친 부분이 어법상 어색한 것은?',
      'options',jsonb_build_array(
        'Jake was a brave boy <u>who</u> lived next door.',
        'Look at the mountain <u>which</u> stands on the horizon.',
        'A pilot is a person <u>whom</u> flies airplanes.',
        'Einstein is the scientist <u>who</u> discovered relativity.',
        'Mozart is a name <u>that</u> everyone knows.'),
      'answer','3'),

    jsonb_build_object('number',53,
      'question',E'다음 중 밑줄 친 부분이 어법상 어색한 것은?',
      'options',jsonb_build_array(
        'Rachel found the boy <u>who</u> took her wallet.',
        'Tom is wearing shoes <u>that</u> are too big for him.',
        'Lisa works for a company <u>who</u> makes robots.',
        'She''d like to meet a man <u>who</u> knows how to cook.',
        'Hemingway was a writer <u>who</u> couldn''t live without adventure.'),
      'answer','3'),

    jsonb_build_object('number',54,
      'question',E'다음 중 밑줄 친 부분이 어법상 어색한 것은?',
      'options',jsonb_build_array(
        'He has a garden <u>which is</u> very beautiful.',
        'The man <u>who is talking to my sister are</u> my uncle.',
        'I joined three clubs <u>which have</u> a lot of members.',
        'Who brought the dog <u>that is sleeping</u> over there?',
        'The chef <u>who works</u> at that restaurant is very talented.'),
      'answer','2'),

    jsonb_build_object('number',55,
      'question',E'다음 중 밑줄 친 부분이 어법상 어색한 것은?',
      'options',jsonb_build_array(
        'I want to have a doll <u>which</u> can talk.',
        'It was about a man <u>who</u> tried to climb the mountain.',
        'A penguin is an animal <u>who</u> walks slowly.',
        'There are lots of people <u>that</u> do not have enough food.',
        'The door <u>which</u> is on the right doesn''t work.'),
      'answer','3'),

    jsonb_build_object('number',56,
      'question',E'다음 중 밑줄 친 부분이 어법상 옳은 것은?',
      'options',jsonb_build_array(
        'This is a boy <u>which</u> comes from Brazil.',
        'I live in a house <u>who</u> has a big backyard.',
        'A dolphin is an animal <u>which</u> has a long nose.',
        'I want to have a robot <u>who</u> can wash my dishes.',
        'A film editor is a person <u>which</u> edits films.'),
      'answer','3'),

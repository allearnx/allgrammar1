...
BEGIN
  ...
  q := jsonb_build_array(
    ...
    jsonb_build_object('number',1, 'type','subjective', 'question',E'다음 괄호 안의 단어를 바르게 배열하여 문장을 완성하시오.\n\nA: What did you get for your birthday?\nB: (got, I, what, a, is, drone).', 'answer',E'A drone is what I got.', 'similar_answers',jsonb_build_array(E'A drone is what I got.', E'A drone is what I got')),
    jsonb_build_object('number',2, 'type','subjective', 'question',E'다음 괄호 안의 단어를 바르게 배열하여 문장을 완성하시오.\n\nA: Did you understand the teacher''s explanation?\nB: Not really. (said, she, I, understand, what, couldn''t).', 'answer',E'I couldn''t understand what she said.', 'similar_answers',jsonb_build_array(E'I couldn''t understand what she said.', E'I couldn''t understand what she said')),
    jsonb_build_object('number',3, 'type','subjective', 'question',E'다음 괄호 안의 단어를 바르게 배열하여 문장을 완성하시오.\n\nA: Why are you upset?\nB: (made, angry, what, was, me, his, attitude).', 'answer',E'What made me angry was his attitude.', 'similar_answers',jsonb_build_array(E'What made me angry was his attitude.', E'What made me angry was his attitude')),
    jsonb_build_object('number',4, 'type','subjective', 'question',E'다음 괄호 안의 단어를 바르게 배열하여 문장을 완성하시오.\n\nA: Is this the jacket you were looking for?\nB: Yes! (exactly, this, wanted, what, is, I).', 'answer',E'This is exactly what I wanted.', 'similar_answers',jsonb_build_array(E'This is exactly what I wanted.', E'This is exactly what I wanted')),
    jsonb_build_object('number',5, 'type','subjective', 'question',E'다음 괄호 안의 단어를 바르게 배열하여 문장을 완성하시오.\n\n(what, about, is, special, that, him, he, never, gives, up).', 'answer',E'What is special about him is that he never gives up.', 'similar_answers',jsonb_build_array(E'What is special about him is that he never gives up.', E'What is special about him is that he never gives up')),

    -- ═══════════════════════════════════════════
    -- 유형 2: 문장 전환 — what으로 바꾸기 (Q6~Q15)
    -- ═══════════════════════════════════════════

    jsonb_build_object('number',6, 'type','subjective', 'question',E'다음 문장을 관계대명사 what을 이용하여 같은 의미의 문장으로 바꾸시오.\n\n<보기> I love the thing that you gave me. → I love what you gave me.\n\nThe thing that he told me was shocking.\n→ _______ was shocking.', 'answer',E'What he told me', 'similar_answers',jsonb_build_array(E'What he told me')),
    jsonb_build_object('number',7, 'type','subjective', 'question',E'다음 문장을 관계대명사 what을 이용하여 같은 의미의 문장으로 바꾸시오.\n\n<보기> I love the thing that you gave me. → I love what you gave me.\n\nTell me the thing that you want to have for lunch.\n→ Tell me _______ for lunch.', 'answer',E'what you want to have', 'similar_answers',jsonb_build_array(E'what you want to have')),
    jsonb_build_object('number',8, 'type','subjective', 'question',E'다음 문장을 관계대명사 what을 이용하여 같은 의미의 문장으로 바꾸시오.\n\n<보기> I love the thing that you gave me. → I love what you gave me.\n\nShe doesn''t have the thing that we are looking for.\n→ She doesn''t have _______.', 'answer',E'what we are looking for', 'similar_answers',jsonb_build_array(E'what we are looking for')),
    jsonb_build_object('number',9, 'type','subjective', 'question',E'다음 문장을 관계대명사 what을 이용하여 같은 의미의 문장으로 바꾸시오.\n\n<보기> I love the thing that you gave me. → I love what you gave me.\n\nThe thing that surprised me most was his answer.\n→ _______ was his answer.', 'answer',E'What surprised me most', 'similar_answers',jsonb_build_array(E'What surprised me most')),
    jsonb_build_object('number',10, 'type','subjective', 'question',E'다음 문장을 관계대명사 what을 이용하여 같은 의미의 문장으로 바꾸시오.\n\n<보기> I love the thing that you gave me. → I love what you gave me.\n\nI will show you the thing that I made for the science fair.\n→ I will show you _______ for the science fair.', 'answer',E'what I made', 'similar_answers',jsonb_build_array(E'what I made')),
    jsonb_build_object('number',11, 'type','subjective', 'question',E'다음 문장을 관계대명사 what을 이용하여 같은 의미의 문장으로 바꾸시오.\n\n<보기> I love the thing that you gave me. → I love what you gave me.\n\nThe things that the victims received were not enough.\n→ _______ were not enough.', 'answer',E'What the victims received', 'similar_answers',jsonb_build_array(E'What the victims received')),
    jsonb_build_object('number',12, 'type','subjective', 'question',E'다음 문장을 관계대명사 what을 이용하여 같은 의미의 문장으로 바꾸시오.\n\n<보기> I love the thing that you gave me. → I love what you gave me.\n\nDo you know the thing that the coach expects from you?\n→ Do you know _______?', 'answer',E'what the coach expects from you', 'similar_answers',jsonb_build_array(E'what the coach expects from you')),
    jsonb_build_object('number',13, 'type','subjective', 'question',E'다음 문장을 관계대명사 what을 이용하여 같은 의미의 문장으로 바꾸시오.\n\n<보기> I love the thing that you gave me. → I love what you gave me.\n\nThe thing that she is most proud of is her patience.\n→ _______ is her patience.', 'answer',E'What she is most proud of', 'similar_answers',jsonb_build_array(E'What she is most proud of')),
    jsonb_build_object('number',14, 'type','subjective', 'question',E'다음 문장을 관계대명사 what을 이용하여 같은 의미의 문장으로 바꾸시오.\n\n<보기> I love the thing that you gave me. → I love what you gave me.\n\nI couldn''t believe the thing that he did during the presentation.\n→ I couldn''t believe _______ during the presentation.', 'answer',E'what he did', 'similar_answers',jsonb_build_array(E'what he did')),
    jsonb_build_object('number',15, 'type','subjective', 'question',E'다음 문장을 관계대명사 what을 이용하여 같은 의미의 문장으로 바꾸시오.\n\n<보기> I love the thing that you gave me. → I love what you gave me.\n\nThe thing that makes this restaurant special is the homemade sauce.\n→ _______ is the homemade sauce.', 'answer',E'What makes this restaurant special', 'similar_answers',jsonb_build_array(E'What makes this restaurant special')),

    -- ═══════════════════════════════════════════
    -- 유형 3: 보기 활용 빈칸 채우기 (Q16~Q25)
    -- ═══════════════════════════════════════════

    jsonb_build_object('number',16, 'type','subjective', 'question',E'다음 <보기>에서 알맞은 표현을 골라 빈칸을 채우시오. (한 번씩만 사용)\n\n<보기>\n• what I needed most    • what she ordered    • what he said\n• what really matters    • what I''ve been looking for\n• what upset her    • what they prepared    • what you promised\n• what I want to try    • what surprised everyone\n\nI don''t think he is telling the truth. I can''t believe _______.', 'answer',E'what he said', 'similar_answers',jsonb_build_array(E'what he said')),
    jsonb_build_object('number',17, 'type','subjective', 'question',E'다음 <보기>에서 알맞은 표현을 골라 빈칸을 채우시오. (한 번씩만 사용)\n\n<보기>\n• what I needed most    • what she ordered    • what he said\n• what really matters    • what I''ve been looking for\n• what upset her    • what they prepared    • what you promised\n• what I want to try    • what surprised everyone\n\nThis is the bookstore! This is exactly _______.', 'answer',E'what I''ve been looking for', 'similar_answers',jsonb_build_array(E'what I''ve been looking for', E'what I have been looking for')),
    jsonb_build_object('number',18, 'type','subjective', 'question',E'다음 <보기>에서 알맞은 표현을 골라 빈칸을 채우시오. (한 번씩만 사용)\n\n<보기>\n• what I needed most    • what she ordered    • what he said\n• what really matters    • what I''ve been looking for\n• what upset her    • what they prepared    • what you promised\n• what I want to try    • what surprised everyone\n\nThe waiter brought the wrong dish. It was not _______.', 'answer',E'what she ordered', 'similar_answers',jsonb_build_array(E'what she ordered')),
    jsonb_build_object('number',19, 'type','subjective', 'question',E'다음 <보기>에서 알맞은 표현을 골라 빈칸을 채우시오. (한 번씩만 사용)\n\n<보기>\n• what I needed most    • what she ordered    • what he said\n• what really matters    • what I''ve been looking for\n• what upset her    • what they prepared    • what you promised\n• what I want to try    • what surprised everyone\n\nHis sudden resignation was _______ at the meeting.', 'answer',E'what surprised everyone', 'similar_answers',jsonb_build_array(E'what surprised everyone')),
    jsonb_build_object('number',20, 'type','subjective', 'question',E'다음 <보기>에서 알맞은 표현을 골라 빈칸을 채우시오. (한 번씩만 사용)\n\n<보기>\n• what I needed most    • what she ordered    • what he said\n• what really matters    • what I''ve been looking for\n• what upset her    • what they prepared    • what you promised\n• what I want to try    • what surprised everyone\n\nA good night''s sleep was _______ after the long trip.', 'answer',E'what I needed most', 'similar_answers',jsonb_build_array(E'what I needed most')),
    jsonb_build_object('number',21, 'type','subjective', 'question',E'다음 <보기>에서 알맞은 표현을 골라 빈칸을 채우시오. (한 번씩만 사용)\n\n<보기>\n• what I needed most    • what she ordered    • what he said\n• what really matters    • what I''ve been looking for\n• what upset her    • what they prepared    • what you promised\n• what I want to try    • what surprised everyone\n\nNot grades but kindness — that is _______ in life.', 'answer',E'what really matters', 'similar_answers',jsonb_build_array(E'what really matters')),
    jsonb_build_object('number',22, 'type','subjective', 'question',E'다음 <보기>에서 알맞은 표현을 골라 빈칸을 채우시오. (한 번씩만 사용)\n\n<보기>\n• what I needed most    • what she ordered    • what he said\n• what really matters    • what I''ve been looking for\n• what upset her    • what they prepared    • what you promised\n• what I want to try    • what surprised everyone\n\nHis rude comment was _______ so much.', 'answer',E'what upset her', 'similar_answers',jsonb_build_array(E'what upset her')),
    jsonb_build_object('number',23, 'type','subjective', 'question',E'다음 <보기>에서 알맞은 표현을 골라 빈칸을 채우시오. (한 번씩만 사용)\n\n<보기>\n• what I needed most    • what she ordered    • what he said\n• what really matters    • what I''ve been looking for\n• what upset her    • what they prepared    • what you promised\n• what I want to try    • what surprised everyone\n\nYou should keep _______ to your teammates.', 'answer',E'what you promised', 'similar_answers',jsonb_build_array(E'what you promised')),
    jsonb_build_object('number',24, 'type','subjective', 'question',E'다음 <보기>에서 알맞은 표현을 골라 빈칸을 채우시오. (한 번씩만 사용)\n\n<보기>\n• what I needed most    • what she ordered    • what he said\n• what really matters    • what I''ve been looking for\n• what upset her    • what they prepared    • what you promised\n• what I want to try    • what surprised everyone\n\nThe food at the festival was amazing — it was beyond _______.', 'answer',E'what they prepared', 'similar_answers',jsonb_build_array(E'what they prepared')),
    jsonb_build_object('number',25, 'type','subjective', 'question',E'다음 <보기>에서 알맞은 표현을 골라 빈칸을 채우시오. (한 번씩만 사용)\n\n<보기>\n• what I needed most    • what she ordered    • what he said\n• what really matters    • what I''ve been looking for\n• what upset her    • what they prepared    • what you promised\n• what I want to try    • what surprised everyone\n\nSkydiving is _______ someday.', 'answer',E'what I want to try', 'similar_answers',jsonb_build_array(E'what I want to try')),

    -- ═══════════════════════════════════════════
    -- 유형 4: 대화 완성 (Q26~Q33)
    -- ═══════════════════════════════════════════

    jsonb_build_object('number',26, 'type','subjective', 'question',E'다음 대화의 빈칸에 알맞은 말을 쓰시오.\n\n<보기> A: What did you buy? B: What I bought was a new laptop.\n\nA: What did your sister cook for dinner?\nB: _______ was spaghetti.', 'answer',E'What my sister cooked for dinner', 'similar_answers',jsonb_build_array(E'What my sister cooked for dinner', E'What she cooked for dinner')),
    jsonb_build_object('number',27, 'type','subjective', 'question',E'다음 대화의 빈칸에 알맞은 말을 쓰시오.\n\n<보기> A: What did you buy? B: What I bought was a new laptop.\n\nA: Are you happy with your exam result?\nB: Not really. The result was not _______.', 'answer',E'what I expected', 'similar_answers',jsonb_build_array(E'what I expected', E'what I had expected', E'what I had hoped for')),
    jsonb_build_object('number',28, 'type','subjective', 'question',E'다음 대화의 빈칸에 알맞은 말을 쓰시오.\n\n<보기> A: What did you buy? B: What I bought was a new laptop.\n\nA: Did the package arrive safely?\nB: Yes, but it wasn''t _______.', 'answer',E'what I ordered', 'similar_answers',jsonb_build_array(E'what I ordered', E'what I had ordered')),
    jsonb_build_object('number',29, 'type','subjective', 'question',E'다음 대화의 빈칸에 알맞은 말을 쓰시오.\n\n<보기> A: What did you buy? B: What I bought was a new laptop.\n\nA: I want to thank you so much.\nB: Oh, don''t mention it. I just did _______.', 'answer',E'what I could', 'similar_answers',jsonb_build_array(E'what I could', E'what I could do', E'what I wanted to do for you')),
    jsonb_build_object('number',30, 'type','subjective', 'question',E'다음 대화의 빈칸에 알맞은 말을 쓰시오.\n\n<보기> A: What did you buy? B: What I bought was a new laptop.\n\nA: You look confused. What happened?\nB: I can''t understand _______ in class today.', 'answer',E'what the teacher explained', 'similar_answers',jsonb_build_array(E'what the teacher explained', E'what we learned')),
    jsonb_build_object('number',31, 'type','subjective', 'question',E'다음 대화의 빈칸에 알맞은 말을 쓰시오.\n\n<보기> A: What did you buy? B: What I bought was a new laptop.\n\nA: Is this the bag that Emma wanted for her birthday?\nB: Yes! This bag is exactly _______.', 'answer',E'what she wanted', 'similar_answers',jsonb_build_array(E'what she wanted', E'what Emma wanted')),
    jsonb_build_object('number',32, 'type','subjective', 'question',E'다음 대화의 빈칸에 알맞은 말을 쓰시오.\n\n<보기> A: What did you buy? B: What I bought was a new laptop.\n\nA: Did the movie meet your expectations?\nB: Totally. It was _______ — even better!', 'answer',E'what I expected', 'similar_answers',jsonb_build_array(E'what I expected', E'beyond what I expected', E'more than what I expected')),
    jsonb_build_object('number',33, 'type','subjective', 'question',E'다음 대화의 빈칸에 알맞은 말을 쓰시오.\n\n<보기> A: What did you buy? B: What I bought was a new laptop.\n\nA: 너 지금 당장 필요한 게 뭐야?\nB: _______ right now is your advice.', 'answer',E'What I need', 'similar_answers',jsonb_build_array(E'What I need', E'What I need most')),

...
BEGIN
  ...
  q := jsonb_build_array(
    ...
    jsonb_build_object('number',15,
      ...
      'acceptedAnswers',jsonb_build_array('How to respond')),
    ...
    jsonb_build_object('number',16,
      ...
      'answer','what to wear',
      'acceptedAnswers',jsonb_build_array('What to wear')),
    ...
    jsonb_build_object('number',18,
      ...
      'acceptedAnswers',jsonb_build_array('When to submit')),
    ...
    jsonb_build_object('number',19,
      ...
      'acceptedAnswers',jsonb_build_array('How to organize')),
    ...
    jsonb_build_object('number',22,
      ...
      'acceptedAnswers',jsonb_build_array('Where to exchange')),
    ...
    jsonb_build_object('number',23,
      ...
      'acceptedAnswers',jsonb_build_array('How to repair')),
    ...
    jsonb_build_object('number',24,
      ...
      'acceptedAnswers',jsonb_build_array('When to begin')),
    ...
    jsonb_build_object('number',25,
      ...
      'acceptedAnswers',jsonb_build_array('What to write')),
    ...
    jsonb_build_object('number',26,
      ...
      'acceptedAnswers',jsonb_build_array('Where to return')),
    ...
    jsonb_build_object('number',27,
      ...
      'acceptedAnswers',jsonb_build_array('How to connect')),
    ...
    jsonb_build_object('number',28,
      ...
      'acceptedAnswers',jsonb_build_array('Who to invite')),
    ...
    jsonb_build_object('number',29,
      ...
      'acceptedAnswers',jsonb_build_array('what she could bring to the picnic','What she should bring to the picnic','What she could bring to the picnic')),
    ...
    jsonb_build_object('number',30,
      ...
      'acceptedAnswers',jsonb_build_array('what we could cook for the party','What we should cook for the party','What we could cook for the party')),
    ...
    jsonb_build_object('number',31,
      ...
      'acceptedAnswers',jsonb_build_array('where she could return the library books','Where she should return the library books','Where she could return the library books')),
    ...
    jsonb_build_object('number',32,
      ...
      'acceptedAnswers',jsonb_build_array('My brother showed me how I should tie a necktie','My brother showed me how I could tie a necktie.','My brother showed me how I could tie a necktie')),

    jsonb_build_object('number',33,
      'question',E'다음 문장을 <보기>와 같이 다시 쓰시오.\n\n<보기>\nWe don''t know where to put the sofa.\n→ We don''t know where we should put the sofa.\n\nI''m not sure when to submit the homework.\n→ I''m not sure ___.',
      'answer','when I should submit the homework',
      'acceptedAnswers',jsonb_build_array('when I could submit the homework','When I should submit the homework','When I could submit the homework')),
    ...
    jsonb_build_object('number',34,
      ...
      'acceptedAnswers',jsonb_build_array('The guide explained to us how we could reach the mountain top safely','The guide explained to us how we should reach the mountain top safely.','The guide explained to us how we should reach the mountain top safely')),
    ...
    jsonb_build_object('number',35,
      ...
      'acceptedAnswers',jsonb_build_array('The notice tells visitors which gate they should enter','The notice tells visitors which gate they could enter.','The notice tells visitors which gate they could enter')),
    ...
    jsonb_build_object('number',36,
      ...
      'acceptedAnswers',jsonb_build_array('where they could hold the festival','Where they should hold the festival','Where they could hold the festival')),
    ...
    jsonb_build_object('number',37,
      ...
      'answer','how to mix',
      'acceptedAnswers',jsonb_build_array('How to mix')),
    ...
    jsonb_build_object('number',39,
      ...
      'acceptedAnswers',jsonb_build_array('Where to camp')),
    ...
    jsonb_build_object('number',40,
      ...
      'answer','when to take',
      'acceptedAnswers',jsonb_build_array('When to take')),
    ...
    jsonb_build_object('number',41,
      ...
      'acceptedAnswers',jsonb_build_array('How to restart')),
    ...
    jsonb_build_object('number',42,
      ...
      'acceptedAnswers',jsonb_build_array('Who to choose')),
    ...
    jsonb_build_object('number',44,
      ...
      'answer','how to grow',
      'acceptedAnswers',jsonb_build_array('How to grow')),
    ...
    jsonb_build_object('number',46,
      ...
      'acceptedAnswers',jsonb_build_array('How to handle')),
    ...
    jsonb_build_object('number',48,
      ...
      'answer','how to fold',
      'acceptedAnswers',jsonb_build_array('How to fold')),
    ...
    jsonb_build_object('number',52,
      ...
      'acceptedAnswers',jsonb_build_array('Where to store')),
    ...
    jsonb_build_object('number',56,
      ...
      'acceptedAnswers',jsonb_build_array('What to select')),
    ...
    jsonb_build_object('number',60,
      ...
      'acceptedAnswers',jsonb_build_array('Where to place')),
    ...
    jsonb_build_object('number',61,
      ...
      'acceptedAnswers',jsonb_build_array('She is learning how to play the piano')),
    ...
    jsonb_build_object('number',62,
      ...
      'acceptedAnswers',jsonb_build_array('We didn''t know where to find the museum','We did not know where to find the museum.','We did not know where to find the museum')),
    ...
    jsonb_build_object('number',63,
      ...
      'acceptedAnswers',jsonb_build_array('He couldn''t decide what to order for lunch','He could not decide what to order for lunch.','He could not decide what to order for lunch')),
    ...
    jsonb_build_object('number',64,
      ...
      'acceptedAnswers',jsonb_build_array('My father told me how to wash a car')),
    ...
    jsonb_build_object('number',65,
      ...
      'acceptedAnswers',jsonb_build_array('Do you remember when to submit the report')),
    ...
    jsonb_build_object('number',66,
      ...
      'acceptedAnswers',jsonb_build_array('I wasn''t sure which path to take','I was not sure which path to take.','I was not sure which path to take')),
    ...
    jsonb_build_object('number',67,
      ...
      'acceptedAnswers',jsonb_build_array('Mina hasn''t decided what to cook tonight yet','Mina has not decided what to cook tonight yet.','Mina has not decided what to cook tonight yet')),
    ...
    jsonb_build_object('number',68,
      ...
      'acceptedAnswers',jsonb_build_array('The teacher showed the students how to use the microscope')),
    ...
    jsonb_build_object('number',69,
      ...
      'acceptedAnswers',jsonb_build_array('They discussed where to set up their tent')),
    ...
    jsonb_build_object('number',70,
      ...
      'acceptedAnswers',jsonb_build_array('My mother knows when to take the medicine')),
    ...
    jsonb_build_object('number',71,
      ...
      'acceptedAnswers',jsonb_build_array('I don''t know who to tell my secret','I do not know who to tell my secret.','I do not know who to tell my secret')),
    ...
    jsonb_build_object('number',72,
      ...
      'acceptedAnswers',jsonb_build_array('My grandfather taught us how to fish')),
    ...
    jsonb_build_object('number',73,
      ...
      'acceptedAnswers',jsonb_build_array('Jason and Emily discussed what to play at the party')),
    ...
    jsonb_build_object('number',74,
      ...
      'acceptedAnswers',jsonb_build_array('She asked where to send the letter')),
    ...
    jsonb_build_object('number',75,
      ...
      'acceptedAnswers',jsonb_build_array('Do you know how to install this software')),
    ...
    jsonb_build_object('number',76,
      ...
      'acceptedAnswers',jsonb_build_array('The coach will tell us when to start practice')),
    ...
    jsonb_build_object('number',77,
      ...
      'acceptedAnswers',jsonb_build_array('She knows how to play the guitar','She knows how to play guitar.','She knows how to play guitar')),

    jsonb_build_object('number',78,
      'question',E'다음 우리말을 주어진 단어를 이용하여 영작하시오.\n\n나는 다음에 무엇을 말해야 할지 몰랐다.\n(know, say)',
      'answer','I didn''t know what to say next.',
      'acceptedAnswers',jsonb_build_array('I didn''t know what to say next','I did not know what to say next.','I did not know what to say next')),

    jsonb_build_object('number',79,
      'question',E'다음 우리말을 주어진 단어를 이용하여 영작하시오.\n\n그들은 어디에서 점심을 먹을지 정했다.\n(decide, eat, lunch)',
      'answer','They decided where to eat lunch.',
      'acceptedAnswers',jsonb_build_array('They decided where to eat lunch')),

    jsonb_build_object('number',80,
      'question',E'다음 우리말을 주어진 단어를 이용하여 영작하시오.\n\n그 의사는 나에게 언제 약을 먹어야 할지 알려주었다.\n(tell, take, medicine)',
      'answer','The doctor told me when to take the medicine.',
      'acceptedAnswers',jsonb_build_array('The doctor told me when to take the medicine','The doctor told me when to take medicine.','The doctor told me when to take medicine')),

    jsonb_build_object('number',81,
      'question',E'다음 우리말을 주어진 단어를 이용하여 영작하시오.\n\n우리 엄마는 나에게 쿠키를 만드는 법을 가르쳐 주셨다.\n(teach, make, cookies)',
      'answer','My mom taught me how to make cookies.',
      'acceptedAnswers',jsonb_build_array('My mom taught me how to make cookies')),
    ...
    jsonb_build_object('number',82,
      ...
      'acceptedAnswers',jsonb_build_array('I can''t decide which university to apply to','I cannot decide which university to apply to.','I cannot decide which university to apply to')),

    jsonb_build_object('number',83,
      'question',E'다음 우리말을 주어진 단어를 이용하여 영작하시오.\n\n너는 시험을 위해 무엇을 공부해야 할지 아니?\n(know, study, exam)',
      'answer','Do you know what to study for the exam?',
      'acceptedAnswers',jsonb_build_array('Do you know what to study for the exam')),

    jsonb_build_object('number',84,
      'question',E'다음 우리말을 주어진 단어를 이용하여 영작하시오.\n\n관광객들은 어디에서 기차를 탈 수 있는지 물었다.\n(ask, catch, train)',
      'answer','The tourists asked where to catch the train.',
      'acceptedAnswers',jsonb_build_array('The tourists asked where to catch the train')),

    jsonb_build_object('number',85,
      'question',E'다음 우리말을 주어진 단어를 이용하여 영작하시오.\n\nTom은 자전거를 수리하는 방법을 배울 것이다.\n(learn, fix, bicycle)',
      'answer','Tom will learn how to fix a bicycle.',
      'acceptedAnswers',jsonb_build_array('Tom will learn how to fix a bicycle')),
    ...
    jsonb_build_object('number',86,
      ...
      'acceptedAnswers',jsonb_build_array('She didn''t know who to ask for help with this problem','She did not know who to ask for help with this problem.','She did not know who to ask for help with this problem')),

    jsonb_build_object('number',87,
      'question',E'다음 우리말을 주어진 단어를 이용하여 영작하시오.\n\n아이들은 방학 동안 무엇을 할지 신이 났다.\n(excited, do, vacation)',
      'answer','The children were excited about what to do during vacation.',
      'acceptedAnswers',jsonb_build_array('The children were excited about what to do during vacation','The children were excited about what to do during the vacation.','The children were excited about what to do during the vacation')),
    ...
    jsonb_build_object('number',88,
      ...
      'acceptedAnswers',jsonb_build_array('Please tell me where to park around here')),
    ...
    jsonb_build_object('number',89,
      ...
      'acceptedAnswers',jsonb_build_array('The chef showed the audience how to cook a perfect steak')),

    jsonb_build_object('number',90,
      'question',E'다음 우리말을 주어진 단어를 이용하여 영작하시오.\n\n우리는 다음 회의를 언제 열어야 할지 아직 결정하지 못했다.\n(decide, hold, meeting)',
      'answer','We haven''t decided when to hold the next meeting yet.',
      'acceptedAnswers',jsonb_build_array('We haven''t decided when to hold the next meeting yet','We have not decided when to hold the next meeting yet.','We have not decided when to hold the next meeting yet'))
  );

...
BEGIN
  ...
  a := jsonb_build_array(E'comes', E'have been', E'has increased', E'requires', E'supported', E'was', E'A number of research have been conducted on the effects of social media on teenagers.', E'The number of people who rely on food banks for their daily meals is increasing in major cities.', E'No error', E'One of the most effective strategies for reducing carbon emissions is switching to renewable energy sources.', E'Over 60 percent of the world''s freshwater resources are locked in glaciers and polar ice caps.', E'Each of the participants in the workshop was required to submit a written reflection after each session.', E'Thirty percent of', E'one fifth of', E'is updated', E'how many / were', E'of the money collected', E'Fifty percent of the', E'is / comes / has grown', E'say', E'Two thirds of the research budget was spent on fieldwork.', E'A number of reports have confirmed the severity of climate change.', E'The number of children living in poverty is still increasing.', E'One of the biggest challenges we face today is climate change.', E'About half of the world''s oxygen is produced by oceanic phytoplankton.', E'A number of new cafes in the city have opened over the past few months.', E'Three quarters of the scientists monitoring the river''s water quality warn that pollution levels are dangerous.', E'Each of the students at the school must record their community service hours at the end of every semester.');

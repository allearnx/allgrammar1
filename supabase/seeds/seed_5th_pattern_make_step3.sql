...
BEGIN
  ...
  q := jsonb_build_array(
    ...
    -- Q1 (보기 형용사: keep + O + OC)
    jsonb_build_object('number',1,'question',E'다음 <보기>에서 알맞은 것을 골라 빈칸을 채우시오.\n\n<보기> calm   nervous   sleepy   proud\n\nSoft music will keep your mind ___.','answer','calm','acceptedAnswers',jsonb_build_array('Calm','Soft music will keep your mind calm.','Soft music will keep your mind calm')),

    -- Q2 (보기 형용사: make + O + OC)
    jsonb_build_object('number',2,'question',E'다음 <보기>에서 알맞은 것을 골라 빈칸을 채우시오.\n\n<보기> calm   nervous   sleepy   proud\n\nReading in the dark will make you ___.','answer','sleepy','acceptedAnswers',jsonb_build_array('Sleepy','Reading in the dark will make you sleepy.','Reading in the dark will make you sleepy')),

    -- Q3 (보기 형용사: make + O + OC)
    jsonb_build_object('number',3,'question',E'다음 <보기>에서 알맞은 것을 골라 빈칸을 채우시오.\n\n<보기> calm   nervous   sleepy   proud\n\nWinning the contest will make your parents ___.','answer','proud','acceptedAnswers',jsonb_build_array('Proud','Winning the contest will make your parents proud.','Winning the contest will make your parents proud')),

    -- Q4 (보기 형용사: make + O + OC)
    jsonb_build_object('number',4,'question',E'다음 <보기>에서 알맞은 것을 골라 빈칸을 채우시오.\n\n<보기> calm   nervous   sleepy   proud\n\nSpeaking in front of many people may make you ___.','answer','nervous','acceptedAnswers',jsonb_build_array('Nervous','Speaking in front of many people may make you nervous.','Speaking in front of many people may make you nervous')),

    -- Q5 (보기 동사: name + O + OC(명사))
    jsonb_build_object('number',5,'question',E'다음 우리말과 같도록 <보기>에서 알맞은 동사를 골라 문장을 완성하시오. (단, 한 번씩만 사용할 것)\n\n<보기> name   leave   consider   keep\n\n우리 아버지는 항상 나를 챔피언이라고 부른다.\n→ My father always ___ me a champion.','answer','names','acceptedAnswers',jsonb_build_array('Names','name','My father always names me a champion.','My father always names me a champion')),

    -- Q6 (보기 동사: leave + O + OC(형용사), 과거)
    jsonb_build_object('number',6,'question',E'다음 우리말과 같도록 <보기>에서 알맞은 동사를 골라 문장을 완성하시오. (단, 한 번씩만 사용할 것)\n\n<보기> name   leave   consider   keep\n\n그녀는 어젯밤 문을 열어 둔 채로 놔두었다.\n→ She ___ the door open last night.','answer','left','acceptedAnswers',jsonb_build_array('Left','leave','She left the door open last night.','She left the door open last night')),

    -- Q7 (보기 동사: consider + O + OC(형용사))
    jsonb_build_object('number',7,'question',E'다음 우리말과 같도록 <보기>에서 알맞은 동사를 골라 문장을 완성하시오. (단, 한 번씩만 사용할 것)\n\n<보기> name   leave   consider   keep\n\n나는 그 문제가 어렵다고 생각했다.\n→ I ___ the problem difficult.','answer','considered','acceptedAnswers',jsonb_build_array('Considered','consider','I considered the problem difficult.','I considered the problem difficult')),

    -- Q8 (보기 동사: keep + O + OC(형용사))
    jsonb_build_object('number',8,'question',E'다음 우리말과 같도록 <보기>에서 알맞은 동사를 골라 문장을 완성하시오. (단, 한 번씩만 사용할 것)\n\n<보기> name   leave   consider   keep\n\n이 코트가 너를 따뜻하게 유지해 줄 것이다.\n→ This coat will ___ you warm.','answer','keep','acceptedAnswers',jsonb_build_array('Keep','This coat will keep you warm.','This coat will keep you warm')),
    ...
    -- Q9 (단어표 영작 1)
    jsonb_build_object('number',9,'question',E'다음 단어들을 이용하여 우리말로 제시한 문장을 영어로 쓰시오. (단, 한 번도 쓰이지 않거나 중복으로 쓰이는 단어가 있을 수 있음)\n\n| exercise | to | him |\n| strong | rain | lonely |\n| cheerful | music | walking |\n| makes | make | us |\n\n운동은 그를 강하게 만든다.','answer','Exercise makes him strong.','acceptedAnswers',jsonb_build_array('Exercise makes him strong')),

    -- Q10 (단어표 영작 2)
    jsonb_build_object('number',10,'question',E'위 단어표를 이용하여 우리말로 제시한 문장을 영어로 쓰시오.\n\n음악은 우리를 즐겁게 만든다.','answer','Music makes us cheerful.','acceptedAnswers',jsonb_build_array('Music makes us cheerful')),

    -- Q11 (단어표 영작 3)
    jsonb_build_object('number',11,'question',E'위 단어표를 이용하여 우리말로 제시한 문장을 영어로 쓰시오.\n\n비는 그를 외롭게 만든다.','answer','Rain makes him lonely.','acceptedAnswers',jsonb_build_array('Rain makes him lonely')),
    ...
    jsonb_build_object('number',16,'question',E'다음 우리말을 영어로 옮길 때 빈칸을 완성하시오.\n\n그 소식은 모든 사람들을 슬프게 만들었다.\n→ The news ___.','answer','made everyone sad','acceptedAnswers',jsonb_build_array('The news made everyone sad.','The news made everyone sad','made everybody sad','The news made everybody sad.','The news made everybody sad')),

    -- Q17 (빈칸 완성: keep + O + OC)
    jsonb_build_object('number',17,'question',E'다음 우리말을 영어로 옮길 때 빈칸을 완성하시오.\n\n그녀는 음식을 신선하게 보관하려고 노력했다.\n→ She tried to ___.','answer','keep the food fresh','acceptedAnswers',jsonb_build_array('She tried to keep the food fresh.','She tried to keep the food fresh')),

    -- Q18 (빈칸 완성: keep + O + OC)
    jsonb_build_object('number',18,'question',E'다음 우리말을 영어로 옮길 때 빈칸을 완성하시오.\n\n너는 영원히 그 계획을 비공개로 유지할 수 없어.\n→ You ___.','answer',E'can''t keep the plan private forever','acceptedAnswers',jsonb_build_array(E'You can''t keep the plan private forever.',E'You can''t keep the plan private forever','cannot keep the plan private forever',E'You cannot keep the plan private forever.',E'You cannot keep the plan private forever','can not keep the plan private forever')),

    -- Q19 (빈칸 완성: 동명사 주어 + make)
    jsonb_build_object('number',19,'question',E'다음 우리말을 영어로 옮길 때 빈칸을 완성하시오.\n\n산책하는 것은 나를 편안하게 만든다.\n→ Taking a walk ___.','answer','makes me relaxed','acceptedAnswers',jsonb_build_array('Taking a walk makes me relaxed.','Taking a walk makes me relaxed')),
    ...
    -- Q23 (활동+감정 영작 2)
    jsonb_build_object('number',23,'question',E'| 음악 발표회 | proud / nervous |\n| 과학 실험 | curious / confused |\n\n<조건>\n• 각 활동과 제시된 단어를 선택 사용할 것\n• make를 활용하여 완전한 문장으로 쓸 것\n\n(2) 과학 실험','answer','Science experiments make me curious.','acceptedAnswers',jsonb_build_array('Science experiments make me curious','Science experiments make me confused.','Science experiments make me confused','The science experiment makes me curious.','The science experiment makes me curious','The science experiment makes me confused.','The science experiment makes me confused')),
    ...
    -- Q24 (문장 변환: 현재)
    jsonb_build_object('number',24,'question',E'다음 주어진 문장과 의미가 통하도록 make를 사용하여 빈칸을 완성하시오.\n\nI feel calm when I listen to classical music.\n→ Classical music ___.','answer','makes me calm','acceptedAnswers',jsonb_build_array('Classical music makes me calm.','Classical music makes me calm')),

    -- Q25 (문장 변환: 과거)
    jsonb_build_object('number',25,'question',E'다음 주어진 문장과 의미가 통하도록 make를 사용하여 빈칸을 완성하시오.\n\nI was confused because of the instructions.\n→ The instructions ___.','answer','made me confused','acceptedAnswers',jsonb_build_array('The instructions made me confused.','The instructions made me confused')),

    -- Q26 (문장 변환: will/미래)
    jsonb_build_object('number',26,'question',E'다음 주어진 문장과 의미가 통하도록 make를 사용하여 빈칸을 완성하시오.\n\nIf you skip breakfast, you will be hungry.\n→ Skipping breakfast ___.','answer','will make you hungry','acceptedAnswers',jsonb_build_array('Skipping breakfast will make you hungry.','Skipping breakfast will make you hungry')),

    -- Q27 (문장 변환: 과거 감정)
    jsonb_build_object('number',27,'question',E'다음 주어진 문장과 의미가 통하도록 make를 사용하여 빈칸을 완성하시오.\n\nI was disappointed because of my friend''s broken promise.\n→ My friend''s broken promise ___.','answer','made me disappointed','acceptedAnswers',jsonb_build_array(E'My friend''s broken promise made me disappointed.',E'My friend''s broken promise made me disappointed')),

    -- Q28 (make 쓰임 분류)
    jsonb_build_object('number',28,'question',E'다음 문장의 밑줄 친 부분의 쓰임이 같은 것끼리 두 가지로 분류하시오.\n\nⓐ The coach tried to <u>make</u> his team confident.\nⓑ My grandmother <u>made</u> us warm soup last winter.\nⓒ Loud noises always <u>make</u> the baby uncomfortable.\nⓓ She promised to <u>make</u> me a birthday cake.\nⓔ Regular exercise will <u>make</u> your body strong.\nⓕ He used to <u>make</u> his friends handmade cards.','answer',E'5형식: ⓐ, ⓒ, ⓔ / 수여동사: ⓑ, ⓓ, ⓕ','acceptedAnswers',jsonb_build_array(E'5형식: a, c, e / 수여동사: b, d, f',E'5형식: ⓐ, ⓒ, ⓔ / 수여동사: ⓑ, ⓓ, ⓕ',E'5형식: ⓐ,ⓒ,ⓔ / 수여동사: ⓑ,ⓓ,ⓕ',E'5형식: a,c,e / 수여동사: b,d,f',E'5형식: ⓐ ⓒ ⓔ / 수여동사: ⓑ ⓓ ⓕ',E'5형식: a c e / 수여동사: b d f',E'5형식-ⓐ, ⓒ, ⓔ / 수여동사-ⓑ, ⓓ, ⓕ',E'5형식-a, c, e / 수여동사-b, d, f',E'5형식 ⓐ, ⓒ, ⓔ 수여동사 ⓑ, ⓓ, ⓕ',E'5형식 a, c, e 수여동사 b, d, f',E'수여동사: ⓑ, ⓓ, ⓕ / 5형식: ⓐ, ⓒ, ⓔ',E'수여동사: b, d, f / 5형식: a, c, e')),
    ...
    -- Q29 (조건부 영작: 대화문)
    jsonb_build_object('number',29,'question',E'다음 대화의 밑줄 친 우리말을 <조건>에 맞게 영작하시오.\n\nA: Why are you crying?\nB: My best friend forgot my birthday. 그것이 나를 정말 속상하게 만들었어.\n\n<조건>\n• make, disappointed를 사용할 것\n• 알맞은 시제로 변형할 것','answer','It made me disappointed.','acceptedAnswers',jsonb_build_array('It made me disappointed','It made me really disappointed.','It made me really disappointed','It made me so disappointed.','It made me so disappointed','That made me disappointed.','That made me disappointed','That made me really disappointed.','That made me really disappointed')),

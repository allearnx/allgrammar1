...
This book __________ (write) by J.K. Rowling.','answer',E'was written','acceptedAnswers',jsonb_build_array(),'explanation',E'write(wrote-written) → was written (과거 수동태)'),
jsonb_build_object('number',2,'question',E'다음 괄호 안의 동사를 알맞은 수동태 형태로 빈칸에 쓰시오.

The windows __________ (clean) every day.','answer',E'are cleaned','acceptedAnswers',jsonb_build_array(),'explanation',E'every day(반복) → 현재 수동태 are cleaned'),
jsonb_build_object('number',3,'question',E'다음 괄호 안의 동사를 알맞은 수동태 형태로 빈칸에 쓰시오.

The Eiffel Tower __________ (design) by Gustave Eiffel.','answer',E'was designed','acceptedAnswers',jsonb_build_array(),'explanation',E'과거 수동태 was designed'),
jsonb_build_object('number',4,'question',E'다음 괄호 안의 동사를 알맞은 수동태 형태로 빈칸에 쓰시오.

Many houses __________ (destroy) by the earthquake.','answer',E'were destroyed','acceptedAnswers',jsonb_build_array(),'explanation',E'복수 주어 + 과거 수동태 were destroyed'),
jsonb_build_object('number',5,'question',E'다음 괄호 안의 동사를 알맞은 수동태 형태로 빈칸에 쓰시오.

English __________ (speak) in many countries.','answer',E'is spoken','acceptedAnswers',jsonb_build_array(),'explanation',E'speak(spoke-spoken) → 현재 수동태 is spoken'),
jsonb_build_object('number',6,'question',E'다음 괄호 안의 동사를 알맞은 수동태 형태로 빈칸에 쓰시오.

The letter __________ (send) to the wrong address yesterday.','answer',E'was sent','acceptedAnswers',jsonb_build_array(),'explanation',E'yesterday → 과거 수동태 was sent'),
jsonb_build_object('number',7,'question',E'다음 괄호 안의 동사를 알맞은 수동태 형태로 빈칸에 쓰시오.

A new building __________ (build) next year.','answer',E'will be built','acceptedAnswers',jsonb_build_array(),'explanation',E'next year → 미래 수동태 will be built'),
jsonb_build_object('number',8,'question',E'다음 괄호 안의 동사를 알맞은 수동태 형태로 빈칸에 쓰시오.

The light bulb __________ (invent) by Edison.','answer',E'was invented','acceptedAnswers',jsonb_build_array(),'explanation',E'과거 수동태 was invented'),
jsonb_build_object('number',9,'question',E'다음 괄호 안의 동사를 알맞은 수동태 형태로 빈칸에 쓰시오.

My wallet __________ (steal) on the subway last night.','answer',E'was stolen','acceptedAnswers',jsonb_build_array(),'explanation',E'steal(stole-stolen) → 과거 수동태 was stolen'),
jsonb_build_object('number',10,'question',E'다음 괄호 안의 동사를 알맞은 수동태 형태로 빈칸에 쓰시오.

The rules __________ (must, follow) by everyone.','answer',E'must be followed','acceptedAnswers',jsonb_build_array(),'explanation',E'조동사 수동태 must + be + p.p.'),
jsonb_build_object('number',11,'question',E'[Part 2] 다음 문장을 수동태로 바꿔 쓰시오.

Fred made a wooden box.','answer',E'A wooden box was made by Fred.','acceptedAnswers',jsonb_build_array(),'explanation',E'능동태 → 수동태: 목적어를 주어로, 동사를 was + p.p.로'),
jsonb_build_object('number',12,'question',E'다음 문장을 수동태로 바꿔 쓰시오.

People speak Korean in Korea.','answer',E'Korean is spoken in Korea.','acceptedAnswers',jsonb_build_array(E'Korean is spoken in Korea by people.',E'Korean is spoken in Korea (by people).'),'explanation',E'by people 생략 가능 (일반인)'),
jsonb_build_object('number',13,'question',E'다음 문장을 수동태로 바꿔 쓰시오.

My mother painted the wall.','answer',E'The wall was painted by my mother.','acceptedAnswers',jsonb_build_array(),'explanation',E'능동태 → 수동태 전환'),
jsonb_build_object('number',14,'question',E'다음 문장을 수동태로 바꿔 쓰시오.

A police officer stopped the car.','answer',E'The car was stopped by a police officer.','acceptedAnswers',jsonb_build_array(),'explanation',E'능동태 → 수동태 전환'),
jsonb_build_object('number',15,'question',E'다음 문장을 수동태로 바꿔 쓰시오.

He can repair the car.','answer',E'The car can be repaired by him.','acceptedAnswers',jsonb_build_array(),'explanation',E'조동사 수동태 can be + p.p.'),
jsonb_build_object('number',16,'question',E'다음 문장을 수동태로 바꿔 쓰시오.

Jimin will break the promise.','answer',E'The promise will be broken by Jimin.','acceptedAnswers',jsonb_build_array(),'explanation',E'미래 수동태 will be + p.p.'),
jsonb_build_object('number',17,'question',E'다음 문장을 수동태로 바꿔 쓰시오.

Did Cathy clean the room?','answer',E'Was the room cleaned by Cathy?','acceptedAnswers',jsonb_build_array(),'explanation',E'의문문 수동태: Was + 주어 + p.p. + by 행위자?'),
jsonb_build_object('number',18,'question',E'다음 문장을 수동태로 바꿔 쓰시오.

My dad didn''t fix my bike.','answer',E'My bike wasn''t fixed by my dad.','acceptedAnswers',jsonb_build_array(E'My bike was not fixed by my dad.'),'explanation',E'부정문 수동태: was not(wasn''t) + p.p.'),
jsonb_build_object('number',19,'question',E'다음 문장을 수동태로 바꿔 쓰시오.

King Sejong made Hangeul.','answer',E'Hangeul was made by King Sejong.','acceptedAnswers',jsonb_build_array(),'explanation',E'능동태 → 수동태 전환'),
jsonb_build_object('number',20,'question',E'다음 문장을 수동태로 바꿔 쓰시오.

The police caught the thief.','answer',E'The thief was caught by the police.','acceptedAnswers',jsonb_build_array(),'explanation',E'catch(caught-caught) → was caught'),
jsonb_build_object('number',21,'question',E'다음 문장을 수동태로 바꿔 쓰시오.

She gave me today''s newspaper.','answer',E'Today''s newspaper was given to me by her.','acceptedAnswers',jsonb_build_array(E'I was given today''s newspaper by her.'),'explanation',E'4형식 수동태 — 직접목적어를 주어로'),
jsonb_build_object('number',22,'question',E'다음 문장을 수동태로 바꿔 쓰시오.

The news made her happy.','answer',E'She was made happy by the news.','acceptedAnswers',jsonb_build_array(),'explanation',E'5형식(make+목적어+형용사) 수동태'),
jsonb_build_object('number',23,'question',E'다음 문장을 수동태로 바꿔 쓰시오.

Careless driving causes many accidents.','answer',E'Many accidents are caused by careless driving.','acceptedAnswers',jsonb_build_array(),'explanation',E'현재 수동태 are caused'),
jsonb_build_object('number',24,'question',E'다음 문장을 수동태로 바꿔 쓰시오.

My sister looked after my cat while I was out.','answer',E'My cat was looked after by my sister while I was out.','acceptedAnswers',jsonb_build_array(),'explanation',E'구동사(look after) 수동태 — 전치사 유지'),
jsonb_build_object('number',25,'question',E'[Part 3] 다음 문장을 능동태로 바꿔 쓰시오.

Star Wars was directed by George Lucas.','answer',E'George Lucas directed Star Wars.','acceptedAnswers',jsonb_build_array(),'explanation',E'수동태 → 능동태: by 뒤 행위자를 주어로'),
jsonb_build_object('number',26,'question',E'다음 문장을 능동태로 바꿔 쓰시오.

The treasure was discovered by the explorer.','answer',E'The explorer discovered the treasure.','acceptedAnswers',jsonb_build_array(),'explanation',E'수동태 → 능동태 전환'),
jsonb_build_object('number',27,'question',E'다음 문장을 능동태로 바꿔 쓰시오.

Was the window opened by him?','answer',E'Did he open the window?','acceptedAnswers',jsonb_build_array(),'explanation',E'수동태 의문문 → 능동태 의문문: Did + 주어 + 동사원형?'),
jsonb_build_object('number',28,'question',E'다음 문장을 능동태로 바꿔 쓰시오.

The grand piano is played by Brian.','answer',E'Brian plays the grand piano.','acceptedAnswers',jsonb_build_array(),'explanation',E'현재 수동태 → 현재 능동태: 3인칭 단수 plays'),
jsonb_build_object('number',29,'question',E'다음 문장을 능동태로 바꿔 쓰시오.

Wine is not sold by them at that store.','answer',E'They don''t sell wine at that store.','acceptedAnswers',jsonb_build_array(E'They do not sell wine at that store.'),'explanation',E'수동태 부정문 → 능동태 부정문'),
jsonb_build_object('number',30,'question',E'다음 문장을 능동태로 바꿔 쓰시오.

The bathroom was cleaned by Jane.','answer',E'Jane cleaned the bathroom.','acceptedAnswers',jsonb_build_array(),'explanation',E'수동태 → 능동태 전환'),
jsonb_build_object('number',31,'question',E'다음 문장을 능동태로 바꿔 쓰시오.

A new school will be built by them.','answer',E'They will build a new school.','acceptedAnswers',jsonb_build_array(),'explanation',E'미래 수동태 → 미래 능동태'),
jsonb_build_object('number',32,'question',E'다음 문장을 능동태로 바꿔 쓰시오.

The lake is visited by seals in the summer.','answer',E'Seals visit the lake in the summer.','acceptedAnswers',jsonb_build_array(),'explanation',E'수동태 → 능동태 전환'),
jsonb_build_object('number',33,'question',E'다음 문장을 능동태로 바꿔 쓰시오.

Was a meeting held by them last week?','answer',E'Did they hold a meeting last week?','acceptedAnswers',jsonb_build_array(),'explanation',E'수동태 의문문 → 능동태 의문문'),
jsonb_build_object('number',34,'question',E'다음 문장을 능동태로 바꿔 쓰시오.

My cat was looked after by my sister while I was out.','answer',E'My sister looked after my cat while I was out.','acceptedAnswers',jsonb_build_array(),'explanation',E'구동사(look after) 수동태 → 능동태'),
jsonb_build_object('number',35,'question',E'[Part 4] 다음 문장에서 어법상 어색한 부분을 찾아 바르게 고쳐 전체 문장을 다시 쓰시오.

Soccer plays in most countries of the world.','answer',E'Soccer is played in most countries of the world.','acceptedAnswers',jsonb_build_array(),'explanation',E'주어 Soccer가 행위의 대상 → 수동태 is played'),
jsonb_build_object('number',36,'question',E'다음 문장에서 어법상 어색한 부분을 찾아 바르게 고쳐 전체 문장을 다시 쓰시오.

The picture was painted to Picasso.','answer',E'The picture was painted by Picasso.','acceptedAnswers',jsonb_build_array(),'explanation',E'수동태 행위자 전치사는 to가 아니라 by'),
jsonb_build_object('number',37,'question',E'다음 문장에서 어법상 어색한 부분을 찾아 바르게 고쳐 전체 문장을 다시 쓰시오.

This house built 100 years ago.','answer',E'This house was built 100 years ago.','acceptedAnswers',jsonb_build_array(),'explanation',E'be동사(was) 누락'),
jsonb_build_object('number',38,'question',E'다음 문장에서 어법상 어색한 부분을 찾아 바르게 고쳐 전체 문장을 다시 쓰시오.

A bus was appeared around the corner.','answer',E'A bus appeared around the corner.','acceptedAnswers',jsonb_build_array(),'explanation',E'appear는 자동사이므로 수동태 불가 → 능동태로'),
jsonb_build_object('number',39,'question',E'다음 문장에서 어법상 어색한 부분을 찾아 바르게 고쳐 전체 문장을 다시 쓰시오.

The letter was written J.K. Rowling.','answer',E'The letter was written by J.K. Rowling.','acceptedAnswers',jsonb_build_array(),'explanation',E'행위자 앞에 by 누락'),
jsonb_build_object('number',40,'question',E'다음 문장에서 어법상 어색한 부분을 찾아 바르게 고쳐 전체 문장을 다시 쓰시오.

Did the room cleaned by her?','answer',E'Was the room cleaned by her?','acceptedAnswers',jsonb_build_array(),'explanation',E'수동태 의문문은 Did가 아닌 Was/Were + 주어 + p.p.'),
jsonb_build_object('number',41,'question',E'다음 문장에서 어법상 어색한 부분을 찾아 바르게 고쳐 전체 문장을 다시 쓰시오.

The singer loves by all Koreans.','answer',E'The singer is loved by all Koreans.','acceptedAnswers',jsonb_build_array(),'explanation',E'be동사(is) 누락 → is loved'),
jsonb_build_object('number',42,'question',E'다음 문장에서 어법상 어색한 부분을 찾아 바르게 고쳐 전체 문장을 다시 쓰시오.

When was invented the bicycle?','answer',E'When was the bicycle invented?','acceptedAnswers',jsonb_build_array(),'explanation',E'의문사 수동태 어순: 의문사 + was + 주어 + p.p.'),
jsonb_build_object('number',43,'question',E'다음 문장에서 어법상 어색한 부분을 찾아 바르게 고쳐 전체 문장을 다시 쓰시오.

This bag is made by leather.','answer',E'This bag is made of leather.','acceptedAnswers',jsonb_build_array(),'explanation',E'재료를 나타낼 때 by가 아닌 of (be made of)'),
jsonb_build_object('number',44,'question',E'다음 문장에서 어법상 어색한 부분을 찾아 바르게 고쳐 전체 문장을 다시 쓰시오.

Something was happened to him.','answer',E'Something happened to him.','acceptedAnswers',jsonb_build_array(),'explanation',E'happen은 자동사이므로 수동태 불가'),
...
The novel "1984" was written <u>by George Orwell</u>.',
  ...
  'acceptedAnswers', jsonb_build_array(E'✕', E'X'),
...
The festival is usually held <u>by people</u> every year.',
  ...
  'acceptedAnswers', jsonb_build_array(E'○', E'O'),
...
The window __________ (cannot, open).',
  ...
  'acceptedAnswers', jsonb_build_array(E'can''t be opened', E'can not be opened'),
...
The gift __________ (not, make) by Sam.',
  ...
  'acceptedAnswers', jsonb_build_array(E'was not made'),
...
__________ all the people __________ (invite) to dinner? No, they weren''t.',
  ...
  'acceptedAnswers', jsonb_build_array(E'Were, invited'),
...
When __________ the first telephone __________ (invent) by Bell?',
  ...
  'acceptedAnswers', jsonb_build_array(E'was, invented'),
...
The door __________ (must not, leave) open.',
  ...
  'acceptedAnswers', jsonb_build_array(E'mustn''t be left'),
...
By whom __________ the car __________ (drive)?',
  ...
  'answer', E'was / driven',
  'acceptedAnswers', jsonb_build_array(E'was, driven'),
...
그 그림은 파블로 피카소에 의해 그려졌다.',
  ...
  'acceptedAnswers', jsonb_build_array(E'The painting was painted by Pablo Picasso.'),
...
한글은 세종대왕에 의해 만들어졌다.',
  ...
  'acceptedAnswers', jsonb_build_array(E'Hangeul was created by King Sejong.'),
  'explanation', E'과거 수동태 was + p.p. + by 행위자'),
...
영어는 전 세계 많은 나라에서 사용된다.',
  ...
  'acceptedAnswers', jsonb_build_array(E'English is spoken in many countries around the world.'),

...
BEGIN
  ...
  a := jsonb_build_array('2', '1', '1', '2', '2', '1', '2', '2', '1', '2', E'can be recycled', E'should be repaired', E'will be discovered', E'must not be parked', E'may be introduced', E'Could / be finished', 'Could', 'be finished', E'should not be thrown', E'will be designed', E'Will / be held', 'Will', 'be held', E'might be planted', '5', '2', '1', '4', '3', '2', '5', '3', '4', '1', E'The final results will be announced by the committee next Friday.', E'Visitors must not enter the restricted area without a permit.', E'No error', E'All mobile phones must not be switched on inside the examination hall.', E'The bridge can be crossed by cyclists and pedestrians during the festival.', E'No error', E'This equipment should be handled with care to prevent damage.', E'No error', E'All waste materials will be separated and recycled at the new facility.', E'The city''s oldest market might be demolished to make way for a new shopping center.', E'will be banned / will be collected / will be cleaned / will be maintained', 'will be banned', 'will be collected', 'will be cleaned', 'will be maintained', E'will be replaced / must not be used / must be submitted', 'will be replaced', 'must not be used', 'must be submitted', E'will be set up / cannot be operated', 'will be set up', 'cannot be operated', E'This museum cannot be visited on Mondays.', E'The documents must be submitted by tomorrow.', E'Where will the next Olympics be held?', E'This information should not be shared with anyone.', E'When will the new rule be enforced?', E'Fresh fruits and vegetables should be kept in the refrigerator.', E'Library books must be returned by Friday.', E'Children should not be left unattended.', E'When will the roof be repaired?', E'Tickets can be purchased at the entrance.', E'The deadline may not be extended.', E'Waste should be sorted before it is recycled.');

...
BEGIN
  ...
  q := jsonb_build_array(
    ...
    jsonb_build_object('number',9,'type','subjective',
      ...
      'answer',E'for us',
      'acceptedAnswers',jsonb_build_array('for us')),
    ...
    jsonb_build_object('number',10,'type','subjective',
      ...
      'answer',E'of her',
      'acceptedAnswers',jsonb_build_array('of her')),
    ...
    jsonb_build_object('number',11,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('for children','for the children','for kids')),
    ...
    jsonb_build_object('number',13,'type','subjective',
      ...
      'answer',E'for him',
      'acceptedAnswers',jsonb_build_array('for him')),
    ...
    jsonb_build_object('number',15,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('for him to pass')),
    ...
    jsonb_build_object('number',16,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('of her to bring')),
    ...
    jsonb_build_object('number',17,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('for us to drink')),
    ...
    jsonb_build_object('number',18,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('of him to spend')),
    ...
    jsonb_build_object('number',19,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('for them to learn')),
    ...
    jsonb_build_object('number',20,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('of her to accept')),
    ...
    jsonb_build_object('number',21,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('for children to cycle')),
    ...
    jsonb_build_object('number',22,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('for us to complete')),
    ...
    jsonb_build_object('number',23,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('of him to hide')),
    ...
    jsonb_build_object('number',24,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('for students to take')),
    ...
    jsonb_build_object('number',25,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('It is hard for them to keep exercising every day.','It is hard for them to keep exercising every day')),
    ...
    jsonb_build_object('number',26,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('It was silly of you to believe such an interesting rumor.','It was silly of you to believe such an interesting rumor')),
    ...
    jsonb_build_object('number',27,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('It is hard for me to understand the book.','It is hard for me to understand the book')),
    ...
    jsonb_build_object('number',28,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('It is challenging for her to finish this work by tomorrow.','It is challenging for her to finish this work by tomorrow')),
    ...
    jsonb_build_object('number',29,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('It is important for cyclists to hear the sound around them.','It is important for cyclists to hear the sound around them')),
    ...
    jsonb_build_object('number',30,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array('It is necessary for students to follow the new school rules.','It is necessary for students to follow the new school rules')),
    ...
    jsonb_build_object('number',43,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array(E'It is helpful for him to keep a diary every day.',E'It is helpful for him to keep a diary every day')),
    ...
    jsonb_build_object('number',44,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array(E'It is fun for us to play on the playground at lunchtime.',E'It is fun for us to play on the playground at lunchtime')),
    ...
    jsonb_build_object('number',45,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array(E'It was wise of her to refuse the offer immediately.',E'It was wise of her to refuse the offer immediately')),
    ...
    jsonb_build_object('number',46,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array(E'It was careless of you to use your smartphone during an important class.',E'It was careless of you to use your smartphone during an important class')),
    ...
    jsonb_build_object('number',47,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array(E'It is impossible for him to finish that amount of homework in a day.',E'It is impossible for him to finish that amount of homework in a day')),
    ...
    jsonb_build_object('number',48,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array(E'It is necessary for students to wear school uniforms.',E'It is necessary for students to wear school uniforms')),
    ...
    jsonb_build_object('number',49,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array(E'It was brave of Mina to save the stranger who was in danger.',E'It was brave of Mina to save the stranger who was in danger',E'It was brave of Mina to save the stranger in danger.')),
    ...
    jsonb_build_object('number',50,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array(E'It is dangerous for him to blindly believe information he finds on the internet.',E'It is dangerous for him to blindly believe information he finds on the internet')),
    ...
    jsonb_build_object('number',51,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array(E'It was kind of them to escort the lost elderly person home.',E'It was kind of them to escort the lost elderly person home')),
    ...
    jsonb_build_object('number',52,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array(E'It was honest of him to admit his mistake openly.',E'It was honest of him to admit his mistake openly')),
    ...
    jsonb_build_object('number',53,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array(E'It is interesting for them to try food from various countries.',E'It is interesting for them to try food from various countries')),
    ...
    jsonb_build_object('number',54,'type','subjective',
      ...
      'acceptedAnswers',jsonb_build_array(E'It was selfish of him to take all the credit in the team project.',E'It was selfish of him to take all the credit in the team project')),
    ...
    jsonb_build_object('number',55,'type','subjective',
      ...
      'answer',E'ⓐ, for → of',
      'acceptedAnswers',jsonb_build_array(E'ⓐ, for → of',E'ⓐ / for → of',E'ⓐ for → of',E'ⓐ, for를 of로',E'ⓐ for를 of로')),
    ...
    jsonb_build_object('number',58,'type','subjective',
      ...
      'answer',E'ⓓ, of → for',
      'acceptedAnswers',jsonb_build_array(E'ⓓ, of → for',E'ⓓ / of → for',E'ⓓ of → for',E'ⓓ, of를 for로',E'ⓓ of를 for로')),

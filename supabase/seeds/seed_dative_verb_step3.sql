...
BEGIN
  ...
  q := jsonb_build_array(
    ...
    jsonb_build_object('number',5,
      ...
      'acceptedAnswers',jsonb_build_array('(A) to (B) for (C) of','(A)to (B)for (C)of','A: to, B: for, C: of','to / for / of','to, for, of')),
    ...
    jsonb_build_object('number',6,
      ...
      'acceptedAnswers',jsonb_build_array('(1) to (2) for (3) to (4) of','(1)to (2)for (3)to (4)of','1: to, 2: for, 3: to, 4: of','to / for / to / of','to, for, to, of')),
    ...
    jsonb_build_object('number',10,
      ...
      'acceptedAnswers',jsonb_build_array('his cousin an invitation','His cousin an invitation')),
    ...
    jsonb_build_object('number',11,
      ...
      'acceptedAnswers',jsonb_build_array('a calculator to his classmate','A calculator to his classmate')),
    ...
    jsonb_build_object('number',12,
      ...
      'acceptedAnswers',jsonb_build_array('my camera to you','My camera to you')),

    jsonb_build_object('number',13,
      'question',E'다음 <보기>를 참고하여 주어진 문장을 다시 쓰시오.\n\n<보기>\nHe gives me a notebook.\n= He gives a notebook to me.\n\nMy aunt cooked us a big dinner.\n= My aunt cooked ___.',
      'answer','a big dinner for us',
      'acceptedAnswers',jsonb_build_array('a big dinner for us','A big dinner for us')),
    ...
    jsonb_build_object('number',14,
      ...
      'acceptedAnswers',jsonb_build_array('a tough question of the mayor','A tough question of the mayor')),
    ...
    jsonb_build_object('number',15,
      ...
      'acceptedAnswers',jsonb_build_array('a new backpack for me','A new backpack for me')),
    ...
    jsonb_build_object('number',16,
      ...
      'acceptedAnswers',jsonb_build_array('My cousin lent her laptop to me.','My cousin lent her laptop to me')),
    ...
    jsonb_build_object('number',17,
      ...
      'acceptedAnswers',jsonb_build_array('Please send me some photos of the trip.','Please send me some photos of the trip')),
    ...
    jsonb_build_object('number',18,
      ...
      'acceptedAnswers',jsonb_build_array('(1) them a favor (2) delicious cookies for you','(1)them a favor (2)delicious cookies for you','1: them a favor, 2: delicious cookies for you','them a favor / delicious cookies for you')),
    ...
    jsonb_build_object('number',19,
      ...
      'acceptedAnswers',jsonb_build_array('He will send some cookies to you.','He will send some cookies to you','He''ll send some cookies to you.','He''ll send some cookies to you')),
    ...
    jsonb_build_object('number',20,
      ...
      'acceptedAnswers',jsonb_build_array('(1) O (2) X → Mom cooked a nice dinner for us.','(1) O (2) X → Mom cooked a nice dinner for us','(1)O (2)X → Mom cooked a nice dinner for us.','(1) O (2) X, Mom cooked a nice dinner for us.')),
    ...
    jsonb_build_object('number',21,
      ...
      'acceptedAnswers',jsonb_build_array('She gave a nice present to me.','She gave a nice present to me')),

    jsonb_build_object('number',22,
      'question',E'다음 문장에서 어색한 부분을 찾아 바르게 고쳐 문장을 다시 쓰시오.\n\nMy dad bought a jacket to my brother.',
      'answer','My dad bought a jacket for my brother.',
      'acceptedAnswers',jsonb_build_array('My dad bought a jacket for my brother.','My dad bought a jacket for my brother')),

    jsonb_build_object('number',23,
      'question',E'다음 문장에서 어색한 부분을 찾아 바르게 고쳐 문장을 다시 쓰시오.\n\nHis mom made for him a birthday cake.',
      'answer','His mom made him a birthday cake.',
      'acceptedAnswers',jsonb_build_array('His mom made him a birthday cake.','His mom made him a birthday cake')),
    ...
    jsonb_build_object('number',24,
      ...
      'acceptedAnswers',jsonb_build_array('The teacher told a funny story to the students.','The teacher told a funny story to the students')),
    ...
    jsonb_build_object('number',25,
      ...
      'acceptedAnswers',jsonb_build_array('ⓐ She cooked dinner for her family. ⓑ He asked a question of his teacher.','ⓐ She cooked dinner for her family. ⓑ He asked a question of his teacher','(1) She cooked dinner for her family. (2) He asked a question of his teacher.','(1) She cooked dinner for her family. (2) He asked a question of his teacher')),
    ...
    jsonb_build_object('number',26,
      ...
      'acceptedAnswers',jsonb_build_array('Lucas sent a package to his cousin last week.','Lucas sent a package to his cousin last week')),
    ...
    jsonb_build_object('number',27,
      ...
      'acceptedAnswers',jsonb_build_array('My uncle gave me a watch.','My uncle gave me a watch')),

    jsonb_build_object('number',28,
      'question',E'다음 괄호 안에 주어진 말을 알맞게 배열하여 문장을 완성하시오.\n\n(sent / Grace / her cousin / a postcard)',
      'answer','Grace sent her cousin a postcard.',
      'acceptedAnswers',jsonb_build_array('Grace sent her cousin a postcard.','Grace sent her cousin a postcard')),

    jsonb_build_object('number',29,
      'question',E'다음 괄호 안에 주어진 말을 알맞게 배열하여 문장을 완성하시오.\n\n(Ms. Jung / an e-mail / us / sent)',
      'answer','Ms. Jung sent us an e-mail.',
      'acceptedAnswers',jsonb_build_array('Ms. Jung sent us an e-mail.','Ms. Jung sent us an e-mail','Ms. Jung sent us an email.','Ms. Jung sent us an email')),

    jsonb_build_object('number',30,
      'question',E'다음 괄호 안에 주어진 말을 알맞게 배열하여 문장을 완성하시오.\n\n(the salt / you / pass / can / to / me)\n→ ___?',
      'answer','Can you pass the salt to me?',
      'acceptedAnswers',jsonb_build_array('Can you pass the salt to me?','Can you pass the salt to me')),
    ...
    jsonb_build_object('number',31,
      ...
      'acceptedAnswers',jsonb_build_array('My mother made me a scarf.','My mother made me a scarf')),
    ...
    jsonb_build_object('number',32,
      ...
      'acceptedAnswers',jsonb_build_array('He will order us delicious pizza.','He will order us delicious pizza','He''ll order us delicious pizza.','He''ll order us delicious pizza')),
    ...
    jsonb_build_object('number',33,
      ...
      'acceptedAnswers',jsonb_build_array('They got me a tablet.','They got me a tablet')),
    ...
    jsonb_build_object('number',34,
      ...
      'acceptedAnswers',jsonb_build_array('Olivia lent her notes to me yesterday.','Olivia lent her notes to me yesterday')),
    ...
    jsonb_build_object('number',35,
      ...
      'acceptedAnswers',jsonb_build_array('I will bring you three cups of coffee.','I will bring you three cups of coffee','I''ll bring you three cups of coffee.','I''ll bring you three cups of coffee')),
    ...
    jsonb_build_object('number',36,
      ...
      'acceptedAnswers',jsonb_build_array('My mom made me a special cake.','My mom made me a special cake','made me a special cake')),
    ...
    jsonb_build_object('number',37,
      ...
      'acceptedAnswers',jsonb_build_array('He teaches us science.','He teaches us science')),
    ...
    jsonb_build_object('number',38,
      ...
      'acceptedAnswers',jsonb_build_array('lent me fifty dollars','Lent me fifty dollars')),
    ...
    jsonb_build_object('number',39,
      ...
      'acceptedAnswers',jsonb_build_array('(1) told me the news (2) made me a sweater / made a sweater for me','(1) told me the news (2) made me a sweater','(1) told me the news (2) made a sweater for me','(1)told me the news (2)made me a sweater','told me the news / made me a sweater','told me the news / made a sweater for me')),
    ...
    jsonb_build_object('number',40,
      ...
      'acceptedAnswers',jsonb_build_array('(1) bought me a doll (2) made me a birthday cake (3) sent me a birthday card','(1)bought me a doll (2)made me a birthday cake (3)sent me a birthday card','bought me a doll / made me a birthday cake / sent me a birthday card')),
    ...
    jsonb_build_object('number',41,
      ...
      'acceptedAnswers',jsonb_build_array('(1) bought him a book (2) threw him a surprise party','(1)bought him a book (2)threw him a surprise party','bought him a book / threw him a surprise party')),
    ...
    jsonb_build_object('number',42,
      ...
      'acceptedAnswers',jsonb_build_array('Give me some advice','give me some advice')),
    ...
    jsonb_build_object('number',43,
      ...
      'acceptedAnswers',jsonb_build_array('(1) showed us old paintings (2) lend your pen to me','(1)showed us old paintings (2)lend your pen to me','showed us old paintings / lend your pen to me')),
    ...
    jsonb_build_object('number',44,
      ...
      'acceptedAnswers',jsonb_build_array('(1) cooked him a meal (2) bought him a toy','(1)cooked him a meal (2)bought him a toy','cooked him a meal / bought him a toy')),
    ...
    jsonb_build_object('number',45,
      ...
      'acceptedAnswers',jsonb_build_array('I want to buy him a present.','I want to buy him a present')),

    jsonb_build_object('number',46,
      'question',E'다음 밑줄 친 우리말을 영작하시오.\n\nI love cooking. I can bake cookies for my neighbors. <u>(A)나는 또한 그들에게 따뜻한 수프를 만들어 줄 수 있습니다.</u>\n\n<보기> make, warm, soup\n\n→ I can also ___ ___ ___ ___.',
      'answer','make them warm soup',
      'acceptedAnswers',jsonb_build_array('make them warm soup','Make them warm soup')),
    ...
    jsonb_build_object('number',47,
      ...
      'acceptedAnswers',jsonb_build_array('(1) Nara lent some money to her friend. (2) Chris wrote a poem for Lily.','(1) Nara lent some money to her friend. (2) Chris wrote a poem for Lily','(1)Nara lent some money to her friend. (2)Chris wrote a poem for Lily.','Nara lent some money to her friend. / Chris wrote a poem for Lily.')),
    ...
    jsonb_build_object('number',48,
      ...
      'acceptedAnswers',jsonb_build_array('(1) Grace told all her classmates the secret. (2) Leo cooked dinner for his family.','(1) Grace told all her classmates the secret. (2) Leo cooked dinner for his family','(1)Grace told all her classmates the secret. (2)Leo cooked dinner for his family.','Grace told all her classmates the secret. / Leo cooked dinner for his family.')),
    ...
    jsonb_build_object('number',49,
      ...
      'acceptedAnswers',jsonb_build_array('(1) Sophie lent her camera to Ethan. (2) Olivia gave her neighbor some help.','(1) Sophie lent her camera to Ethan. (2) Olivia gave her neighbor some help','(1)Sophie lent her camera to Ethan. (2)Olivia gave her neighbor some help.','Sophie lent her camera to Ethan. / Olivia gave her neighbor some help.')),
    ...
    jsonb_build_object('number',50,
      ...
      'acceptedAnswers',jsonb_build_array('You can always ask a question of me.','You can always ask a question of me')),
    ...
    jsonb_build_object('number',51,
      ...
      'acceptedAnswers',jsonb_build_array('(1) tells funny stories to the children (2) bought a new laptop for me','(1)tells funny stories to the children (2)bought a new laptop for me','tells funny stories to the children / bought a new laptop for me')),
    ...
    jsonb_build_object('number',52,
      ...
      'acceptedAnswers',jsonb_build_array('buy some flowers for her','Buy some flowers for her')),
    ...
    jsonb_build_object('number',53,
      ...
      'acceptedAnswers',jsonb_build_array('I will give my brother this necklace as a graduation present.','I will give my brother this necklace as a graduation present','I''ll give my brother this necklace as a graduation present.','I''ll give my brother this necklace as a graduation present')),
    ...
    jsonb_build_object('number',54,
      ...
      'acceptedAnswers',jsonb_build_array('I showed my friends the new bag.','I showed my friends the new bag')),
    ...
    jsonb_build_object('number',55,
      ...
      'acceptedAnswers',jsonb_build_array('(1) Olivia made her friends lunch. (2) Olivia made lunch for her friends.','(1) Olivia made her friends lunch. (2) Olivia made lunch for her friends','(1)Olivia made her friends lunch. (2)Olivia made lunch for her friends.','Olivia made her friends lunch. / Olivia made lunch for her friends.')),
    ...
    jsonb_build_object('number',56,
      ...
      'acceptedAnswers',jsonb_build_array('Noah gives children free snacks on Saturday.','Noah gives children free snacks on Saturday')),
    ...
    jsonb_build_object('number',57,
      ...
      'acceptedAnswers',jsonb_build_array('Hana bought me a book.','Hana bought me a book')),
    ...
    jsonb_build_object('number',58,
      ...
      'acceptedAnswers',jsonb_build_array('(1) Ryan bought a new watch for Sophie. (2) Ryan bought Sophie a new watch.','(1) Ryan bought a new watch for Sophie. (2) Ryan bought Sophie a new watch','(1)Ryan bought a new watch for Sophie. (2)Ryan bought Sophie a new watch.','Ryan bought a new watch for Sophie. / Ryan bought Sophie a new watch.')),
    ...
    jsonb_build_object('number',59,
      ...
      'acceptedAnswers',jsonb_build_array('ⓐ I want to buy my parents two mugs. ⓑ I will buy Max a key chain.','ⓐ I want to buy my parents two mugs. ⓑ I will buy Max a key chain','(1) I want to buy my parents two mugs. (2) I will buy Max a key chain.','(1) I want to buy my parents two mugs. (2) I will buy Max a key chain','ⓐ I want to buy my parents two mugs. ⓑ I''ll buy Max a key chain.','ⓐ I want to buy my parents two mugs. ⓑ I''ll buy Max a key chain')),
    ...
    jsonb_build_object('number',60,
      ...
      'acceptedAnswers',jsonb_build_array('(1) made a necklace for (2) will write a letter to','(1)made a necklace for (2)will write a letter to','made a necklace for / will write a letter to'))
  );

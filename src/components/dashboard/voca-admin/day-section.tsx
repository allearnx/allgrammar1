...
import { Plus, Trash2, ChevronDown, ChevronRight, FileText, Loader2, Check, X as XIcon } from 'lucide-react';
...
function PdfBulkExtract({ bookId, onCreated }: { bookId: string; onCreated: () => void }) {

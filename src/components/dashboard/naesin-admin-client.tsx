...
import type { NaesinTextbook, NaesinUnit, NaesinVocabulary, NaesinVocabQuizSet } from '@/types/database';
...
// ============================================
// Vocab Quiz Set Management
// ============================================

function CreateQuizSetFromSelection({
  unitId,
  vocabList,
  selectedIds,
  onCreated,
...
function VocabQuizSetManager({ unitId }: { unitId: string }) {

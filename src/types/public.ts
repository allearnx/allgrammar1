...
export const CATEGORY_PAGE_CONFIG: Record<CourseCategory, CategoryPageTheme> = {
  grammar: {
    ...
    heroBgClass: 'from-brand-50 to-white',
    heroTitleGradientClass: 'from-brand-600 via-brand-500 to-cyan-400',
    loadingColorClass: 'text-brand-500',
    badgeColorClass: 'bg-brand-500',
    cardHoverTextClass: 'group-hover:text-brand-600',
    teacherBorderClass: 'border-brand-100',
    teacherFallbackBgClass: 'bg-brand-100',
    teacherFallbackIconClass: 'text-brand-500',
    priceColorClass: 'text-brand-600',
    emptyBgClass: 'bg-brand-100',
    emptyIconClass: 'text-brand-400',
    ctaBgClass: 'bg-brand-50',
  },
  voca: {
  ...
  international: {
    ...
    heroTitleGradientClass: 'from-sky-600 via-blue-500 to-brand-400',

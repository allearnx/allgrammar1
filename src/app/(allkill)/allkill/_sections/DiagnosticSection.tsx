 ...
 * 오른쪽은 실제 진단 결과 화면을 본뜬 목업 카드 (샘플 수치).
 */
export default function DiagnosticSection() {
  return (
    <section className="ak-section" style={{ padding: '96px 24px', background: C.blueLight }}>
      <div className="ak-parent-grid" style={{ maxWidth: 1080, margin: '0 auto' }}>
        ...
        <div>
          ...
          <p className="ak-sub" style={{ color: C.gray, marginLeft: 0, maxWidth: 520 }}>

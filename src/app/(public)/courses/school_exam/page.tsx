...
import { whyCards, curriculumSteps, oldWay, newWay, trialPersonalItems, trialAcademyItems, premiumItems } from './school-exam-data';
import './naesin.css';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-14 items-start">
            ...
            <div className="rounded-3xl overflow-hidden shadow-[0_4px_24px_rgba(30,27,75,0.06)] border border-slate-200 bg-white text-left flex flex-col">
              <div className="px-6 pt-7 pb-5">
                <h3 className="sinaesin-serif text-[0.75rem] font-bold text-slate-400 tracking-[0.1em] uppercase mb-3">
                  체험 · 개인
                </h3>
                <div className="text-[1.8rem] font-black leading-none tracking-[-1px] text-indigo-950">체험하기</div>
                <div className="text-[0.78rem] text-slate-400 mt-1.5">혼자서 먼저 경험해 보세요</div>
              </div>
              <div className="border-t border-slate-100 px-6 py-5 flex-1">
                {trialPersonalItems.map((item) => (
                  <div key={item} className="flex items-start gap-2.5 mb-2.5">
                    <div className="w-[18px] h-[18px] rounded-full bg-slate-100 flex items-center justify-center text-[0.55rem] text-slate-400 shrink-0 mt-0.5 font-black">&#x2713;</div>
                    <span className="text-[0.82rem] text-slate-500 leading-[1.6] break-keep">{item}</span>
                  </div>
                ))}
              </div>
              <div className="px-6 pb-6">
                <a
                  href="/signup"
                  className="block w-full text-center py-3 rounded-xl bg-slate-100 text-slate-600 font-bold text-[0.85rem] transition-all hover:bg-slate-200"
                >
                  체험하기 &rarr;
                </a>
              </div>
            ...
            <div className="rounded-3xl overflow-hidden shadow-[0_16px_48px_rgba(30,27,75,0.2)] border-[2px] border-[#c9a84c]/50 bg-indigo-950 text-left flex flex-col relative md:-mt-4 md:mb-[-16px]">
              <div className="absolute top-0 inset-x-0 h-0.5 [background:linear-gradient(90deg,transparent,#c9a84c,#f0d080,#c9a84c,transparent)]" />
              <div className="absolute top-4 right-4 bg-[#c9a84c] text-indigo-950 text-[0.7rem] font-bold px-3 py-1 rounded-full">
                ✦ 추천
              </div>
              <div className="px-7 pt-8 pb-6">
                <h3 className="sinaesin-serif text-[0.82rem] font-bold text-[#c9a84c] tracking-[0.1em] uppercase mb-3">
                  선생님과 함께 · 4주
                </h3>
                <div className="text-[2.4rem] font-black leading-none tracking-[-2px] text-white">&#x20A9;180,000</div>
                <div className="text-[0.78rem] text-white/40 mt-1.5">4주 완성 프로그램</div>
                <div className="inline-flex items-center gap-1.5 bg-[#c9a84c]/15 border border-[#c9a84c]/30 text-[#c9a84c] text-[0.72rem] font-bold px-3 py-1 rounded-full mt-3">
                  수강생 95% · 95점 달성
                </div>
              </div>
              <div className="border-t border-white/10 px-7 py-6 flex-1">
                {premiumItems.map((item) => (
                  <div key={item} className="flex items-start gap-3 mb-3">
                    ...
                    <span className="text-[0.88rem] text-white/80 leading-[1.6] break-keep">{item}</span>
                  </div>
                ))}
              </div>
            ...
            <div className="rounded-3xl overflow-hidden shadow-[0_4px_24px_rgba(30,27,75,0.06)] border border-slate-200 bg-white text-left flex flex-col">
              <div className="px-6 pt-7 pb-5">
                ...
                <div className="text-[1.8rem] font-black leading-none tracking-[-1px] text-indigo-950">체험하기</div>
                <div className="text-[0.78rem] text-slate-400 mt-1.5">학원에서 먼저 경험해 보세요</div>
              </div>
              <div className="border-t border-slate-100 px-6 py-5 flex-1">

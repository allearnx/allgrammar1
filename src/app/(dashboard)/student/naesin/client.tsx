              ...
              {freeUnitLimit > 0 && units.length > freeUnitLimit && (
                <div className="mt-6 space-y-4">
                  ...
                  <div className="rounded-2xl overflow-hidden">
                    <div className="bg-gradient-to-r from-brand-600 to-brand-600 px-5 py-6 text-center text-white">
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    ...
                    <div className="rounded-xl border-2 border-brand-200 bg-gradient-to-br from-brand-50 to-white p-5">
                      <div className="flex items-start gap-3">
                        <div className="rounded-lg bg-brand-100 p-2 shrink-0">
                          <GraduationCap className="h-5 w-5 text-brand-600" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <h4 className="font-bold text-brand-900">학원에서 배정받기</h4>
                            <span className="text-[10px] font-bold bg-brand-600 text-white px-2 py-0.5 rounded-full">추천</span>
                          </div>
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {['전체 단원 해금', '선생님 진도 관리', '시험 대비 문제'].map((tag) => (
                              <span key={tag} className="text-[11px] bg-brand-100 text-brand-700 px-2 py-0.5 rounded-full font-medium">{tag}</span>
                            ))}
                          </div>
                        </div>
                      </div>
                    ...
                    <Link href="/courses/school_exam" className="block group">
                      <div className="rounded-xl border border-gray-200 bg-white p-5 transition-all group-hover:border-brand-300 group-hover:shadow-md">
                        <div className="flex items-start gap-3">

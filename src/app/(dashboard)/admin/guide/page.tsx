...
const FAQ_ITEMS = [
  ...
  {
    question: '문제 정답이 잘못되었을 때 어떻게 수정하나요?',
    answer:
      '학생 상세 → 상세 리포트 → 오답 분석 탭 → "오답 상세 보기" 버튼을 누르면 문제풀이 오답 카드가 나옵니다. "정답처리" 버튼을 누르면 학생의 답을 정답으로 인정하고, "정답 수정" 버튼을 누르면 기존 정답을 새 정답으로 교체한 뒤 전체 학생을 재채점합니다. 정답처리 시 같은 답을 쓴 다른 학생도 자동으로 정답 처리됩니다.',
  },
];

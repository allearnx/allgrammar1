...
import { AcademySetupChecklist } from '@/components/shared/academy-setup-checklist';
...
export default async function AdminDashboard() {
  ...
  const [studentRes, teacherRes, grammarRes, memoryRes, academyRes] = await Promise.all([
    ...
    admin.from('academies').select('name, max_students, invite_code').eq('id', user.academy_id!).single(),
  ]);

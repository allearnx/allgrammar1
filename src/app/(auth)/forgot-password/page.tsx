        ...
        <div className="rounded-3xl p-8 bg-white/70 backdrop-blur-xl border border-gray-200/50 shadow-xl shadow-gray-200/50">
          {sent ? (
            <div className="text-center space-y-4 py-4">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-brand-100 to-brand-100 rounded-2xl mb-2">
              ...
              <Link
                href="/login"
                className="inline-block mt-2 text-brand-600 font-bold hover:text-brand-700 transition-colors"
              >
                로그인으로 돌아가기
              </Link>
            </div>
